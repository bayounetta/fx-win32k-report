...
export default ({ data }) => (
  <div>
    ...
    <div className="page">
      ...
      This is a log capturing navigation to mozilla.org followed by printing the page to pdf.
      </p>
      <div className={logStyles.stack}>
        {data.allPrintingShortReportJson.edges.map((node) => (
          <div>
